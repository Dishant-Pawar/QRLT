...
const SUPABASE_URL = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://mhavebdwyhuiwgchczfl.supabase.co';
const SUPABASE_SERVICE_KEY = process.env.SUPABASE_SERVICE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1oYXZlYmR3eWh1aXdnY2hjemZsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NzY3OTUwOSwiZXhwIjoyMDYzMjU1NTA5fQ.oncufRsWKCCzMmpinnjp7xswkPt68Rkx-rxVRJYo8EM';
  ...
  for (const menu of menus) {
    if (menu.background_image_url && menu.background_image_url.includes('localhost')) {
      const newUrl = menu.background_image_url.replace(
        ...
        'https://mhavebdwyhuiwgchczfl.supabase.co'
      );
